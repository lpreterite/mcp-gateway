...
| 2 | OpenCode MCP 工具调用验证 | P1 | ⏳ 待人工验证 | M5 |
| 3 | Stdio Bridge 未实现 | P1 | ⏳ 待开始 | M3 |
| 4 | gwservice/pool 覆盖率需进一步提升 | P2 | 🔄 进行中 | M5 |
| 5 | architecture.md 文档需更新为 Go 版本 | P2 | ⏳ 待开始 | M6 |
